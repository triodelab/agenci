        ...
        <form onSubmit={(e) => void handleVerify(e)} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <input
              ...
              placeholder="123456"
              disabled={busy}
              className="h-10 w-full rounded-[8px] border border-[#d4d0cb] bg-white px-3.5 text-center text-lg font-semibold tracking-[0.3em] text-[#1C1C1C] outline-none transition focus:border-[#b8b3ae] focus:ring-2 focus:ring-[#1C1C1C]/8 disabled:opacity-50"
            />
          </div>
