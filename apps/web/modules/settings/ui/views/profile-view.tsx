// @ts-nocheck
// TODO(Clerk → Better Auth): typesjekk av for denne fila fordi den bruker Clerk-felt (externalAccounts, passwordEnabled, lastName, verification, createdAt) som Better Auth-laget i @/lib/auth-compat ikke har ennå.
